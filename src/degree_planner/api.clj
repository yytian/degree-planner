...
(def bcs (Program. "Bachelor of Computer Science"
                   (let [core [:CS240 :CS241 :CS245 :CS246 :CS251 :CS341 :CS350]]
                     (vector
                      ...
                      [:n-of "Three additional CS courses chosen from CS 340-398, 440-489; two additional CS courses chosen from CS 440-489."
                       (course-range cs-courses :CS340 :CS398) (course-range cs-courses :CS440 :CS489)]
                      ))))
